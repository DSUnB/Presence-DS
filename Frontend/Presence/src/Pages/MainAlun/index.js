...
return (
    <Div> 
        ...
        <View style={style.botao}>
            <Pressables iconeM='login' texto='Entrar em uma turma' click={() => setModalActive1(true)} />
        </View>
        <Modal visible={modalActive1} animationType='fade' transparent={true} >
            <View style={style.fundoModal}>
                <LinearGradient
                    ...
                    style={style.modal}
                >
                    <IconX style={style.close} name='close-circle' size={30} onPress={() => setModalActive1(false)}/>
                    <Text style={{fontFamily:'poppinsb', fontSize:15, color:'white' }}>Insira o código da turma</Text>
                        <Inputs place="Código" iconeF='book' />

                        <PressablesModal texto='Entrar' click={() => setModalActive1(false)}/>
                </LinearGradient>
            </View>
        </Modal>
